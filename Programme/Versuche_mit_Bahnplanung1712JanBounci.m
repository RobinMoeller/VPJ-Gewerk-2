...
H_zeros=zeros([73 151]);
 ...
 H_ones(41:52,1:12)=0;
 [x,y]=meshgrid(0:50:7500,0:50:3600); 
 surf(x,y,((H1+H0+H2+H4).*H_ones)+H3)
 figure(2)
 subplot(2,3,1)
 surf(x(1:2:73,1:2:151),y(1:2:73,1:2:151),((H0(1:2:73,1:2:151))))
 subplot(2,3,2)
 surf(x(1:2:73,1:2:151),y(1:2:73,1:2:151),((H1(1:2:73,1:2:151))))
 subplot(2,3,3)
 surf(x(1:2:73,1:2:151),y(1:2:73,1:2:151),((H2(1:2:73,1:2:151))))
 subplot(2,3,4)
 surf(x(1:2:73,1:2:151),y(1:2:73,1:2:151),H3(1:2:73,1:2:151))
 subplot(2,3,5)
 surf(x(1:2:73,1:2:151),y(1:2:73,1:2:151),((H4(1:2:73,1:2:151))))
 subplot(2,3,6)
 surf(x(1:2:73,1:2:151),y(1:2:73,1:2:151),H5(1:2:73,1:2:151))
 
 %%
 H_ones(52:73,111:122)=0;
 [x,y]=meshgrid(0:50:7500,0:50:3600); 
 surf(x,y,((H1+H0+H2+H4).*H_ones)+H5+H3)
 
%%

 if Zone == 1 %Rinne nach rechts weg
