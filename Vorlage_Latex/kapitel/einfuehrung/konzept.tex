...
\\
Aus diesem Grund wurden hinter den Stationen EinbahnstraÃŸen entworfen in den der Robotino geschätzt wieder in den freien Bereich geführt wird. Hiermit wird jedoch noch nicht das Problem der Roboterbegegnung vor den Zielen verhindert.
...
\begin{figure}[h]
	...
	\caption{Lageplan der FIFO PlÃ¤tze}
	\label{FIFOPlan}
\end{figure}
\\
